...
document.getElementsByClassName("score")[0].appendChild(currentScore);
document.getElementsByClassName("score")[1].appendChild(maxScore);
...
function playDoor(door) {
  ...
  if (numClosedDoors === 0) {
    ...
    if (score > parseInt(maxScore.innerHTML)) {
      maxScore.innerHTML = score + "";
    }
